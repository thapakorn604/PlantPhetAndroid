...
public class nineMonthSticky extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.nine_month_sticky);
        ...
        cartesian.setTitle("สถิติราคาของข้าวเหนียวย้อนหลัง8เดือน");
