...
public class twoYearJasmine extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.two_year_rice);
        ...
        data.add(new ValueDataEntry("2-2561", 14542.0));
        data.add(new ValueDataEntry("3-2561", 15130.0));
        data.add(new ValueDataEntry("4-2561", 15235.0));
        ...
        cartesian.setTitle("สถิติราคาของข้าวหอมมะลิย้อนหลัง2ปี");
